...
class StomaIntro extends StatefulWidget {
  const StomaIntro({super.key});

  @override
  State<StomaIntro> createState() => _AllVideosState();
}

class _AllVideosState extends State<StomaIntro> {
